...
//{
//	public partial class FileManagerControl : Panel
//	{
//		private IHost _host;
...
//		private TreeView treeView_Dirs;
//		private GridView listView_File;
//		private ContextMenu rightMenu_FileManager;
...
//			btn_Dir = new Button { Text = "Dir" };

//			treeView_Dirs = new TreeView();
//			listView_File = new GridView();
//			var panel0_1 = new Splitter
//			{
//				Panel1 = treeView_Dirs,
//				Panel2 = listView_File,
//				Orientation = SplitterOrientation.Horizontal,
//				Position = 200
//			};

//			var layout = new DynamicLayout { Padding = new Padding(0, 0), Spacing = new Size(5, 5) };
//			layout.AddRow(textBox_url, btn_Dir);
//			layout.AddRow(panel0_1);
