	...
	public abstract class TabStyleProvider : Component
	{
			...
			set {
				...
				if (this._ShowTabCloser){
					if (value.X + (int)(this._Radius/2) < -6){
						((System.Windows.Forms.TabControl)this._TabControl).Padding = new Point(0, value.Y);
					} else {
						((System.Windows.Forms.TabControl)this._TabControl).Padding = new Point(value.X + (int)(this._Radius/2) + 6, value.Y);
					}
				} else {
					if (value.X + (int)(this._Radius/2) < 1){
						((System.Windows.Forms.TabControl)this._TabControl).Padding = new Point(0, value.Y);
					} else {
						((System.Windows.Forms.TabControl)this._TabControl).Padding = new Point(value.X + (int)(this._Radius/2) -1, value.Y);
					}
				}
			}
		}
		...
		public bool HotTrack {
			...
			set {
				...
				((System.Windows.Forms.TabControl)this._TabControl).HotTrack = value;
			}
		}
